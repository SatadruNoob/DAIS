...
const DEFAULT_SETTINGS = {
  ...
  sponsorText: "Powered by DAIS", // default sponsor text
  sponsorLink: "", // default sponsor link
  position: "bottom-right", // position of chat button/window
  assistantName: "DAIS Chat Assistant", // default assistant name
  ...
  useEffect(() => {
    function fetchAttribs() {
      ...
      if (
        ...
        throw new Error(
          "[DAIS Embed Module::Abort] - Invalid script tag setup detected. Missing required parameters for boot!"
        );
