...
import DAISIcon from "@/assets/dais-icon.svg";
    ...
    return (
      <div className="py-[5px]">
        ...
        >
          {role === "assistant" && (
            <img
              src={embedderSettings.settings.assistantIcon || DAISIcon}
              alt="DAIS Icon"
          ...
          <div
            ...
            className={`py-[11px] px-4 flex flex-col ${
              error
                ...
                : role === "user"
                  ? `${embedderSettings.USER_STYLES} dais-user-message`
                  : `${embedderSettings.ASSISTANT_STYLES} dais-assistant-message`
