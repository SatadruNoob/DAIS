...
export const LLM_SELECTION_PRIVACY = {
  ...
  native: {
    ...
    description: [
      "Your model and chats are only accessible on this DAIS instance",
    ],
    logo: DAISIcon,
  },
  togetherai: {
...
export const VECTOR_DB_PRIVACY = {
  ...
  lancedb: {
    name: "LanceDB",
    description: [
      "Your vectors and document text are stored privately on this instance of DAIS",
    ],
    logo: LanceDbLogo,
  },
};
...
export const EMBEDDING_ENGINE_PRIVACY = {
  native: {
    name: "DAIS Embedder",
    description: [
      "Your document text is embedded privately on this instance of DAIS",
    ],
    logo: DAISIcon,
  },
  openai: {
