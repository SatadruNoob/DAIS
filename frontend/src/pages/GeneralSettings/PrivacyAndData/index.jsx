      ...
      <div className="relative rounded-lg">
        ...
        <div className="flex flex-col items-left space-y-2">
          <p className="text-white/80 text-xs rounded-lg w-96">
            ...
            look on{" "}
            <a
              href="https://github.com/search?q=repo%3AMintplex-Labs%2Fdais%20.sendTelemetry(&type=code"
          ...
          <p className="text-white/80 text-xs rounded-lg w-96">
            ...
            so that we can continue to improve DAIS for you.{" "}
            <a
