...
const doc = {
  info: {
    version: '1.0.0',
    title: 'DAIS Developer API',
    description: 'API endpoints that enable programmatic reading, writing, and updating of your DAIS instance. UI supplied by Swagger.io.',
  },
