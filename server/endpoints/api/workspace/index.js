      ...
      content: {
        "application/json": {
          example: {
            ...
            deletes: ["custom-documents/dais.txt-hash.json"]
          }
        }
      }
    }
       ...
       "application/json": {
         schema: {
           ...
           example: {
              ...
              sources: [{title: "dais.txt", chunk: "This is a context chunk used in the answer of the prompt by the LLM,"}],
              close: true,
           ...
           example: [
            ...
            },
            {
            ...
            },
             {
              ...
              sources: [{title: "dais.txt", chunk: "This is a context chunk used in the answer of the prompt by the LLM. This will only return in the final chunk."}],
              close: true,
              error: "null | text string of the failure mode."
            }
          ]
